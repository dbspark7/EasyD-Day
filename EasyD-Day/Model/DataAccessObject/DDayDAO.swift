...
class DDayDAO: UIViewController {
    ...
    func fetch(keyword text: String? = nil) -> [DDayData] {
        ...
        do {
            ...
            for record in resultset {
                ...
                data.isTodayExtensionSelected = record.isTodayExtensionSelected
    ...
    func insert(_ data: DDayData) {
        ...
        object.isTodayExtensionSelected = data.isTodayExtensionSelected!
    ...
    // Today Extension 선택을 수정하는 메소드
    func editTodayExtension(objectID: NSManagedObjectID, isTodayExtensionSelected: Bool) -> Bool {
        
        let object = self.coreDataStack.mainQueueContext.object(with: objectID)
        
        object.setValue(isTodayExtensionSelected, forKey: "isTodayExtensionSelected")
